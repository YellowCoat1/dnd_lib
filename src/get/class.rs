...
async fn json_to_class(
    ...
    ClassBuilder::new()
        ...
        .set_skill_proficiency_choices(skill_proficiency_choices.0, skill_proficiency_choices.1)
        .set_spellcasting(spellcasting)
        .add_multiclassing_prerequisites(multiclassing_prerequisites)
